...
export default function SmallservicesPrice () {
  ...
  return (
      <section className="w-full h-full py-20  mx-auto">
        {/**Grid layout */}
        <div className=" max-w-[1340px] mx-auto px-4 sm:px-10 flex justify-center items-center flex-col w-full gap-4 sm:gap-10">
          ...
          <div className="flex flex-col md:flex-row gap-4 sm:gap-10  w-full h-full justify-center">
            <div onClick={toOpen1} className="card cursor-pointer w-full flex flex-col p-4 items-start gap-4  justify-center h-min">
                ...
                I'm here to bring your brand to life through logo design. 
                  ...
                  {isopen1 ? (
                    <div className='flex flex-col items-start'>
                         ...
                         <h1 className=" mt-2 text-2xl font-bold "><span className="text-md">$</span>49-299</h1>
            ...
            <div onClick={toOpen2} className="cursor-pointer card flex flex-col p-4 items-start gap-4 h-content justify-center w-full h-min">
              <div className='flex items-center gap-4 text-2xl'>
                  ...
                  {isopen2 ? (
                    <div className='flex flex-col items-start'>
                         <h2 className='text-gray-400 mt-4'>Your brand deserves ad creatives that make a statement. I specialize in crafting Figma ad creatives that not only catch the eye but also drive engagement and conversions. With a keen eye for design, I ensure your message shines through in every visual. Let's turn your ad campaigns into success stories.</h2>
                          ...
                          <h1 className=" mt-2 text-2xl font-bold "><span className="text-md">$</span>49-999</h1>
                          <Link className='btn4 mt-4' href="/Contact">Contact</Link>
                    </div>
                    ...
                    ''
                        ...
                        {/**Lower grid */}
          <div className='flex flex-col gap-5 items-start p-4 w-full card'>
              {/**third card */}
